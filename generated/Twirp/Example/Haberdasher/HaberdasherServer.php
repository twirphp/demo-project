...
{
    const PATH_PREFIX = '/twirp/twirp.example.haberdasher.Haberdasher/';
    ...
    public function handle(ServerRequestInterface $req): ResponseInterface
    {
        ...
        switch ($req->getUri()->getPath()) {
            case '/twirp/twirp.example.haberdasher.Haberdasher/MakeHat':
    ...
    private function handleMakeHatJson(array $ctx, ServerRequestInterface $req): ResponseInterface
    {
        ...
        try {
            ...
            $in = new \Twirp\Example\Haberdasher\Size();
